...
SELECT
    ...
    (SELECT COUNT(*) FROM reservations WHERE status = 'REQUESTED') AS requested_reservations,
    (SELECT COUNT(*) FROM reservations WHERE status = 'APPROVED') AS approved_reservations,
    (SELECT COUNT(*) FROM reservations WHERE status = 'PICKED_UP') AS picked_up_reservations,
    (SELECT COUNT(*) FROM reservations WHERE status = 'RETURNED') AS completed_reservations,
    (SELECT COUNT(*) FROM reservations WHERE status = 'DENIED') AS denied_reservations,
    (SELECT COUNT(*) FROM reservations WHERE status = 'CANCELED') AS cancelled_reservations,
