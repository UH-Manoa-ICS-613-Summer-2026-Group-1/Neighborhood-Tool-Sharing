...
// Calls POST /api/invitations with { recipient_email }
// The invite link is printed to the Docker console (email not yet implemented)
...
const SendInvite = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // Get the stored JWT token for the Authorization header
            const token = localStorage.getItem('access_token')

            // POST /api/invitations — sends invite link to Docker console
