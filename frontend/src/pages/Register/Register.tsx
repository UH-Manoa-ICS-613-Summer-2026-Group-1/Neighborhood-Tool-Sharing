...
const Register = () => {
    ...
    useEffect(() => {
        ...
        const validateToken = async () => {
            try {
                ...
                setTokenError(err instanceof Error ? err.message : 'Could not validate invitation. Please try again.')
            } finally {
                setValidating(false)
            }
        }
    ...
    const handleSubmit = async (e: React.SyntheticEvent) => {
        ...
        // Password strength validation — mirrors backend rules in UserRegisterRequest
